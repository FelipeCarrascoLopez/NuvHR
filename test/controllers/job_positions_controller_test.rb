...
class JobPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_position" do
    assert_difference('JobPosition.count') do
      post job_positions_url, params: { job_position: { department_id: @job_position.department_id, title: @job_position.title } }
    end
  ...
  test "should update job_position" do
    patch job_position_url(@job_position), params: { job_position: { department_id: @job_position.department_id, title: @job_position.title } }
